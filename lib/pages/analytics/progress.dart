...
import 'package:app/widgets/common/charts/chartsWidget.dart';
import 'package:app/widgets/common/text/big_text.dart';
import 'package:app/widgets/common/button/button_base.dart';
import 'package:app/widgets/analytics/progress_widget.dart';
              ...
              children: [
                ...
                */
                SizedBox(
                  ...
                  child: FutureBuilder(
                      future: progressController.getBudget(typeQuery),
                      initialData: null,
                      builder: (context, snapshot) {
                        if (snapshot.connectionState == ConnectionState.waiting) {
                          ...
                          var analitics = progressController.analytics;
                ...
                Row(
                  ...
                  children: [
                    ...
                    Obx(() => TagResult(
                        title: "Día",
                        value:
                            formatNumberEnglish(progressController.getTotalAmmountDay(typeQuery)))
                    ),
                    const Spacer(),
                    Obx(() => TagResult(
                        title: "Semana",
                        value: formatNumberEnglish(progressController
                            .getTotalAmmountWeek(typeQuery)))
                    ),
                    const Spacer(),
                    Obx(() => TagResult(
                        title: "Mes",
                        value: formatNumberEnglish((progressController.getTotalAmmountMonh(typeQuery)))
                    )),
                    const Spacer(),
                  ],
                ),
